    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$1, 30, 3, 642);
    			attr_dev(h11, "class", "info__des svelte-17qztde");
    			add_location(h11, file$1, 31, 3, 689);
    			attr_dev(div0, "class", "info");
    			add_location(div0, file$1, 29, 2, 620);
    			attr_dev(div1, "class", "profile");
    			add_location(div1, file$1, 34, 2, 893);
    			attr_dev(header, "class", "svelte-17qztde");
    			add_location(header, file$1, 28, 1, 609);
    			attr_dev(article, "class", "svelte-17qztde");
    			add_location(article, file$1, 38, 1, 1041);
    			attr_dev(footer, "class", "svelte-17qztde");
    			add_location(footer, file$1, 39, 1, 1062);
    			attr_dev(main, "class", "svelte-17qztde");
    			add_location(main, file$1, 27, 0, 601);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
